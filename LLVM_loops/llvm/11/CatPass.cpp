  ...
  struct CAT : public FunctionPass {
    ...
    bool analyzeLoop (
      ...
      if (  loop->isLoopSimplifyForm()  &&
        ...
        auto peelingCount = 1;
        auto unrolled = UnrollLoop(loop, 2, tripCount, forceUnroll, allowRuntime, allowExpensiveTripCount, preserveCondBr, preserveOnlyFirst, tripMultiple, peelingCount, false, &LI, &SE, &DT, &AC, &ORE, true);
