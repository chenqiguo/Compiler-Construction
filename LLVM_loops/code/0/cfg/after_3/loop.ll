...
.loopexit.loopexit:                               ; preds = %17, %11
  %.lcssa.ph = phi i32 [ %14, %11 ], [ %18, %17 ]
  br label %.loopexit
...
; <label>:11:                                     ; preds = %17, %.peel.newph
  %12 = phi i32 [ %7, %.peel.newph ], [ %19, %17 ]
  %13 = phi i32 [ %6, %.peel.newph ], [ %18, %17 ]
...
; <label>:17:                                     ; preds = %11
  %18 = tail call i32 @myF(i32 %14)
  %19 = add nuw nsw i32 %15, 1
  %20 = icmp eq i32 %19, %0
  br i1 %20, label %.loopexit.loopexit, label %11
}
