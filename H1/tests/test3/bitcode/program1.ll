...
@str.5 = private unnamed_addr constant [8 x i8] c"H1: End\00", align 1
...
define dso_local void @CAT_execution() local_unnamed_addr #0 {
  ...
  %7 = tail call i8* @CAT_new(i64 0) #3
  tail call void @CAT_sub(i8* %7, i8* %4, i8* %1) #3
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %4 = tail call i32 @puts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.5, i64 0, i64 0))
  ret i32 0
}
