...
; <label>:8:                                      ; preds = %2
  ...
  %11 = tail call i32 @strcmp(i8* %10, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #4
  %12 = icmp eq i32 %11, 0
...
; <label>:17:                                     ; preds = %14, %8
  ...
  %19 = tail call i64 @CAT_get(i8* %18) #4
  %20 = tail call i8* @CAT_new(i64 %19) #4
  %21 = tail call i64 @CAT_get(i8* %20) #4
  %22 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i64 %21)
  %23 = tail call i64 @CAT_invocations() #4
  %24 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0), i64 %23)
  ret i32 0
}
