...
define dso_local void @CAT_execution(i8*) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  ...
  call void @CAT_add(i8* %6, i8* %7, i8* %8)
  %9 = load i8*, i8** %2, align 8
  %10 = call i64 @CAT_get(i8* %9)
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i64 %10)
  %12 = load i8*, i8** %3, align 8
  %13 = call i64 @CAT_get(i8* %12)
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i64 %13)
  ret void
}
...
define dso_local i32 @main(i32, i8**) #0 {
  ...
  call void @CAT_execution(i8* %8)
  %9 = call i64 @CAT_invocations()
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0), i64 %9)
  ret i32 0
}
