...
define dso_local void @CAT_execution(i32) #0 {
  ...
  call void @CAT_set(i8* %8, i64 42)
  %9 = load i8**, i8*** @g, align 8
  %10 = load i8*, i8** %9, align 8
  %11 = call i64 @CAT_get(i8* %10)
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i64 %11)
  ret void
}
...
define dso_local i32 @main(i32, i8**) #0 {
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i64 %7)
  ret i32 0
}
