...
define dso_local i32 @main(i32, i8**) #0 {
  ...
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i64 %24)
  ...
  %38 = call i64 @CAT_invocations()
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0), i64 %38)
  ret i32 0
}
