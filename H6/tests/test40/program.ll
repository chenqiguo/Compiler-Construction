...
define dso_local void @CAT_execution(i32) local_unnamed_addr #0 {
  ...
  call void @CAT_set(i8* %4, i64 42) #4
  %5 = load i8**, i8*** @g, align 8, !tbaa !2
  %6 = load i8*, i8** %5, align 8, !tbaa !2
  %7 = call i64 @CAT_get(i8* %6) #4
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i64 %7)
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  tail call void @CAT_execution(i32 undef)
  %3 = tail call i64 @CAT_invocations() #4
  %4 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i64 %3)
  ret i32 0
}
