            ...
            if (CallInst *in_callInst = dyn_cast<CallInst>(inInst)) {
              ...
              // BEGIN of try!!!
                ...
                if ((inst_arg1 == inst_arg2) && (inInst_arg0 == inst_arg1)) {
                  ...
                  reachDef1 = NULL;
                  isSet1 = 0;
                  foldConst1 = constantFolding(inst_arg1, insts, INs, argSet/*, escapeSet*/);
                  reachDef2 = NULL;
                  isSet2 = 0;
                  foldConst2 = foldConst1;
                }
                if (inInst_arg0 == inst_arg1) {
                  errs() << "inInst_arg0 == inst_arg1: " << *inst_arg1 << "\n";
                  ...
                  isSet1 = 0;
                  foldConst1 = constantFolding(inst_arg1, insts, INs, argSet/*, escapeSet*/); // instead, call constant folding
                  errs() << "$$$return from recursion const fold\n";
                }
                else if (inInst_arg0 == inst_arg2) {
                  errs() << "inInst_arg0 == inst_arg2: " << *inst_arg2 << "\n";
                  reachDef2 = NULL; // for probable constant folding later
                  isSet2 = 0;
                  foldConst2 = constantFolding(inst_arg2, insts, INs, argSet/*, escapeSet*/); // instead, call constant folding
                  errs() << "$$$return from recursion const fold\n";
                }
              }
              // END of try
