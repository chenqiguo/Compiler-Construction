...
; <label>:8:                                      ; preds = %7, %1
  ...
  %12 = tail call i8* @CAT_new(i64 0) #3
  tail call void @CAT_add(i8* %12, i8* %2, i8* %11) #3
  %13 = tail call i8* @CAT_new(i64 0) #3
  tail call void @CAT_add(i8* %13, i8* %11, i8* %12) #3
  %14 = tail call i8* @CAT_new(i64 0) #3
  %15 = tail call i8* @CAT_new(i64 0) #3
  tail call void @CAT_add(i8* %14, i8* %2, i8* %2) #3
  tail call void @CAT_add(i8* %15, i8* %2, i8* %2) #3
  %16 = tail call i64 @CAT_get(i8* %15) #3
  %17 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i64 %16)
  ret void
}
